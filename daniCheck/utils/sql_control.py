...
class Info(BaseModel):
    student_name: str
    student_sfz: str = 'null'
    student_class: Union[int, str] = None  # 可选参数,不传入时默认none
    student_photo: Union[str, None] = 'null'
...
'''
    ...
    def insert(self, info: Info):
        ...
        VALUES ('{info.student_sfz}', '{info.student_name}', '{info.student_class}', '{info.student_photo}','{info.parent_name}','{info.parent_tel}');
        '''
